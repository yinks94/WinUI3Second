...
using MySecondApp.Core.Services;
    ...
    public App()
    {
        ...
        Host = Microsoft.Extensions.Hosting.Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddTransient<DataTablePage>();
                services.AddTransient<GridContentDetailViewModel>();
                services.AddTransient<GridContentDetailPage>();
                services.AddTransient<GridContentViewModel>();
                services.AddTransient<GridContentPage>();
